...
export const SalesOverview: React.FC = () => {
  ...
  return (
    <div className=" bg-white rounded-md py-4 flex flex-col gap-4 h-full">
      ...
      <div className="flex gap-4 pb-2 border-b justify-end Container">
...
const InfoCard: React.FC<TInfoCardProps> = ({ amount, attribute }) => {
  ...
  return (
    <Card className="bg-red-200 w-full">
      <CardBody>
